...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { difference: @table.difference, loss: @table.loss, name: @table.name, played: @table.played, position: @table.position, win: @table.win } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { difference: @table.difference, loss: @table.loss, name: @table.name, played: @table.played, position: @table.position, win: @table.win } }
