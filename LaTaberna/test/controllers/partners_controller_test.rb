...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { id_player1: @partner.id_player1, id_player2: @partner.id_player2, name: @partner.name } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { id_player1: @partner.id_player1, id_player2: @partner.id_player2, name: @partner.name } }
