...
class TablesTest < ApplicationSystemTestCase
  ...
  test "creating a Table" do
    ...
    fill_in "Difference", with: @table.difference
    fill_in "Loss", with: @table.loss
    fill_in "Name", with: @table.name
    fill_in "Played", with: @table.played
    fill_in "Position", with: @table.position
    fill_in "Win", with: @table.win
